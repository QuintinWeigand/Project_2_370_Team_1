package com.example.Project2.spring;
    ...
    public ServletContextInitializer initializer() {
        return new ServletContextInitializer() {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "com.example.Project2");
                servletContext.setInitParameter("tapestry.development-modules", "com.example.Project2.services.DevelopmentModule");
